      ...
      >
        <MotionStack variants={stagger} spacing={6} w="100">
          ...
          <MotionText
            ...
            variants={fadeInUp}
          >
            Based in Vietnam • Available for opportunities
          </MotionText>
          ...
          >
            ...
            <br />I'm a full-stack developer with a passion for building scalable digital solutions and AI integration. I specialize in React, Node.js, and creating intelligent applications that deliver seamless user experiences.
          </MotionText>
          <MotionButton
            size="lg"
            variant="outline"
            ...
            as={'a'}
            href="mailto:nwokep.net812@gmail.com"
            target="_blank"
            whileHover={{ scale: 1.1 }}
            whileTap={{ scale: 0.9 }}
          >
